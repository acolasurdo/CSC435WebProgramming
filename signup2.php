...
<html>
	...
	<body>
		...
		<div>
			<form action="signup-submit-2.php" method="post">
				
				<fieldset>
				<legend>New User Signup: </legend>
				<strong>Name:</strong> <input type='text' name= "name" size="16" ><br> <span><?= $nameErr?></span>
				...
				<strong>Seek Gender(s):</strong><input type="checkbox" name="seekmale" value="M">Male
										<input type="checkbox" name="seekfemale" value="F">Female<br>
